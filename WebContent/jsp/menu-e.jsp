...
<div style="display:inline-flex">
	...
	<form action = "../servlet/menu-sort" method = "post">
		<input class = "button" type ="submit" value ="価格が安い順" name = "c">

		<input class = "here" type ="submit" value ="価格が高い順" name = "ex">
...
<p>
	...
	<% List<SiteBean> expensiveList = (List<SiteBean>) session.getAttribute("expensiveList"); %>

	<% if (expensiveList.size()!=0) { %>

	<table>
	
	<% for (SiteBean s : expensiveList) { %>
